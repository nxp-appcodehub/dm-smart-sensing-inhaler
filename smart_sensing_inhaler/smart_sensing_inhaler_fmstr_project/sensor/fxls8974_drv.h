...
/**
 * @file fxls8974_drv.h
 * @brief The fxls8974_drv.h file describes the FXLS8974CF driver interface and structures.
 */

#ifndef FXLS8974_DRV_H_
#define FXLS8974_DRV_H_
 ...
 *  @reeentrant  No
 *  @return      ::FXLS8974_I2C_Initialize() returns the status .
 */
 ...
 *  @param[in]  :  fxls8974_i2c_sensorhandle_t *pSensorHandle, handle to the sensor handle.
 ...
 *  @return        void.
 *  @constraints   This can be called any number of times only after FXLS8974_I2C_Initialize().
 *                 Application has to ensure that previous instances of these APIs have exited before invocation.
 *  @reeentrant    No
 */
 ...
 *               Application has to ensure that previous instances of these APIs have exited before invocation.
 *  @reeentrant  No
 *  @return      ::FXLS8974_I2C_Configure() returns the status .
 */
 ...
 *               Application has to ensure that previous instances of these APIs have exited before invocation.
 *  @reeentrant  No
 *  @return      ::FXLS8974_I2C_ReadData() returns the status .
 */
 ...
 *  @param[in]   pSensorHandle handle to the sensor.
 *  @constraints This can be called only after FXLS8974_I2C_Initialize().
 *               Application has to ensure that previous instances of these APIs have exited before invocation.
 *  @reeentrant  No
 *  @return      ::FXLS8974_I2C_DeInit() returns the status .
 */
 ...
 *               Application has to ensure that previous instances of these APIs have exited before invocation.
 *  @reeentrant  No
 *  @return      ::FXLS8974_SPI_Initialize() returns the status .
 */
 ...
 *  @param[in]  :  fxls8974_spi_sensorhandle_t *pSensorHandle, handle to the sensor handle.
 ...
 *               Application has to ensure that previous instances of these APIs have exited before invocation.
 *  @reeentrant  No
 *  @return      ::FXLS8974_SPI_Configure() returns the status .
 */
 ...
 *               Application has to ensure that previous instances of these APIs have exited before invocation.
 *  @reeentrant  No
 *  @return      ::FXLS8974_SPI_ReadData() returns the status .
 */
 ...
 *  @details     This function made sensor in a power safe state and de initialize its handle.
 *  @param[in]   pSensorHandle      handle to the sensor.
 *  @constraints This can be called only after after FXLS8974_SPI_Initialize().
 *               Application has to ensure that previous instances of these APIs have exited before invocation.
 *  @reeentrant  No
 *  @return      ::FXLS8974_SPI_Deinit() returns the status .
 */
